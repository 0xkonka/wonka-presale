        ...
        <ChildWrapper>
          <List component='div' sx={{ py: skin === 'bordered' ? 2.625 : 2.75 }}>
            <ListItem
              ...
              className={clsx('menu-group', { 'Mui-selected-parent': hasActiveChild(item, currentURL) })}
              ...
              >
                ...
                >
                  <ListItemIcon sx={{ mr: 2, color: menuOpen ? 'text.primary' : 'text.secondary' }}>
                    <UserIcon icon={icon} fontSize={28} color={menuOpen ? theme.palette.primary.main : 'white'} />
                  </ListItemIcon>
                  {/* <img src={`/images/icons/customized-icons/${icon}.svg`}/> */}
                  <Typography
                    {...(menuTextTruncate && { noWrap: true })}
                    sx={{color: menuOpen ? theme.palette.primary.main : 'white'}}
                ...
                >
                  ...
                  <Icon color={menuOpen ? theme.palette.primary.main : 'white'} icon={menuOpen ? 'tabler:chevron-right' : 'tabler:chevron-down'} fontSize='1.125rem' />
                </Box>
              </Box>
            </ListItem>
